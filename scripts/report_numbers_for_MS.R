...
print(paste(round(sum(D$FemaleParticipantsNumber,na.rm = TRUE) / sum(D$BOTHMaleAndFemaleParticipantsNumber,na.rm = TRUE)*100,2),'%'))
#### Other numbers
...
print(paste(round(nrow(D)/nrow(d)*100,0),'%'))
